...
from packages.valory.connections.twikit.connection import (
    PUBLIC_ID,
    SrrDialogues,
    TwikitConnection,
    tweet_to_json,
...
class TestGetResponse:
    ...
    async def test_success(self) -> None:
        ...
        with (
            ...
            patch("packages.valory.connections.twikit.connection.asyncio.sleep"),
            patch(
                "packages.valory.connections.twikit.connection.secrets.randbelow",
                return_value=0,
            ),
        ):
            result = await conn._get_response(msg, dialogue)
