...
class TestHttpHandlerProperties:
    ...
    def test_synchronized_data(self) -> None:
        ...
        with patch(
            "packages.dvilela.skills.memeooorr_abci.handlers.SynchronizedData"
        ) as mock_sd:
    ...
    def test_funds_status(self) -> None:
        ...
        with patch(
            "packages.dvilela.skills.memeooorr_abci.handlers.GET_FUNDS_STATUS_METHOD_NAME",
            "get_funds_status",
        ):
...
class TestHttpHandlerDbMethods:
    ...
    def test_db_connect(self) -> None:
        ...
        handler = _make_http_handler()
        with patch(
            "packages.dvilela.skills.memeooorr_abci.handlers.peewee.SqliteDatabase"
        ) as mock_sqlite:
            mock_db = MagicMock()
            mock_sqlite.return_value = mock_db
            with patch(
                "packages.dvilela.skills.memeooorr_abci.handlers.db"
            ) as mock_proxy:
...
class TestGetWeb3Instance:
    ...
    def test_success(self) -> None:
        ...
        with patch("packages.dvilela.skills.memeooorr_abci.handlers.Web3"):
    ...
    def test_exception(self) -> None:
        ...
        with patch(
            "packages.dvilela.skills.memeooorr_abci.handlers.Web3",
...
class TestCheckUsdcBalance:
    ...
    def test_success(self) -> None:
        ...
        with patch(
            "packages.dvilela.skills.memeooorr_abci.handlers.Web3.to_checksum_address",
...
class TestGetLifiQuoteSync:
    ...
    def test_success(self) -> None:
        ...
        with patch(
            "packages.dvilela.skills.memeooorr_abci.handlers.requests.get",
