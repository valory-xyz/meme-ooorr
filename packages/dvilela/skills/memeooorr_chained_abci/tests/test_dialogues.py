...
from packages.dvilela.skills.memeooorr_chained_abci.dialogues import (
    AbciDialogue,
    AbciDialogues,
    ContractApiDialogue,
...
class TestDialogueAliases:
    ...
    def test_srr_dialogues(self) -> None:
        """Test SrrDialogues alias."""
        assert SrrDialogues is BaseSrrDialogues

    def test_kv_store_dialogue(self) -> None:
        """Test KvStoreDialogue alias."""
        assert KvStoreDialogue is BaseKvStoreDialogue

    def test_kv_store_dialogues(self) -> None:
        """Test KvStoreDialogues alias."""
        assert KvStoreDialogues is BaseKvStoreDialogues
